      ...
      components={{
        ...
        code: ({ node, className, children, ...props }) => {
          ...
          if (match?.length) {
            ...
            return (
              <div className=" bg-graident-dark text-gray-300 border-[0.5px] rounded-md ">
                <div className="flex items-center justify-between px-5 py-2 border-b-[0.5px] ">
            ...
            return (
              ...
              <code className="text-lg break-words px-1 rounded-sm" {...props}>
                {children}
              </code>
            );
          }
